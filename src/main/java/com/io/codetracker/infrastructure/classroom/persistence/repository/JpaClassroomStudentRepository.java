...
public interface JpaClassroomStudentRepository extends JpaRepository<ClassroomStudentEntity, Long> {
    ...
    List<ClassroomStudentEntity> findByClassroomIdAndStatusOrderByJoinedAt(String classroomId, StudentStatus status);
    List<ClassroomStudentEntity> findByClassroomIdAndStatusOrderByJoinedAtDesc(String classroomId, StudentStatus status);
}